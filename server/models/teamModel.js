...
const updateTask = async (req, res) => {
  try {
    ...
    /*
      Manager/Admin:
      Can update every task.

      Member:
      Can update only the task
    ...
    */
    ...
    if (manager) {
      ...
      if (
        ...
        existingTask.assignment_reason =
          req.body.assignment_reason;
      }
    }
